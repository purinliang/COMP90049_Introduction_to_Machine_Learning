...
def task7():
    """
    Performs Task 7: SVM Regularization Analysis.
    1. Reads the urbansound8k_features_small.csv dataset.
    2. Trains LinearSVC models with different C values.
    3. Plots the accuracy for each C value.
    ...
    # 1. Train SVM models with a linear kernel and different C values
    c_values = [0.01, 0.1, 0.5]
    accuracies = []

    for c in c_values:
        print(f"--- Starting training for C = {c} ---")
    ...
    print("--- All models trained. Generating plot... ---")

    # 2. Draw a line plot to visualize the change in performance
    ...
    print(f"Task 7 completed. Plot saved to {plot_file_name}.")