...
def task5():
    ...
    # 3. Split the unscaled data into training and testing sets with stratification
    ...
    # 4. Train a GaussianNB classifier on the unscaled training data
    gnb = GaussianNB()
    gnb.fit(X_train, y_train)

    # 5. Evaluate the model's accuracy on the unscaled test data
